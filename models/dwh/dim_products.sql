{{ config(
    ...
    post_hook="{{ updating_audit('dim_products') }}"
) }}
...
new_records AS (
    SELECT
        ...
        coalesce(lead(effective_date,1) over (partition by product_id order by effective_date), to_timestamp_ntz('3001-01-01 00:00:00')) as expiry_date
